...
def load_policy_iteration_config(config, env_configs, train_env, seed, log_file):
    ...
    if config["group"] == "MEICRL" or config['group'] == "InfoICRL" or config['group'] == "ICRL" or config['group'] == "Binary":
        ...
        pi_parameters.update({"contrastive_weight": config['CN']['contrastive_weight']})
        pi_parameters.update({"loss_type": config['iteration']['loss_type']})
...
def load_ppo_config(config, train_env, seed, log_file):
    ...
    if config["group"] == "PPO" or config["group"] == "GAIL":
        ppo_parameters.update({
            ...
            or config['group'] == "MEICRL" or config['group'] == "InfoICRL" or config['group'] == "GFICRL":
        ...
        if config['group'] == "MEICRL" or config['group'] == "InfoICRL" or config['group'] == "GFICRL" or config['group'] == "ICRL":
            ...
            ppo_parameters.update({"loss_type": config['PPO']['loss_type']})
