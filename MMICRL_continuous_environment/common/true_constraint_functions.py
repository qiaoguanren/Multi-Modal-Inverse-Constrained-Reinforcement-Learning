...
def get_true_constraint_function(env_id, env_configs={}, agent_id=0, c_id=None, games_by_aids={},group=""):
    ...
    if env_id in ["HCWithPosTest-v0",
        ...
        if c_id == 0:
            ...
            return partial(wall_infront, 0.015)
        else:
            raise ValueError("Unknown cid {0}.".format(c_id))
...
def get_true_constraint_function2(env_id, env_configs={}, constraint_id=0):
    """Returns the cost function correpsonding to provided env)"""
    c_id = constraint_id
    if env_id in ["HCWithPosTest-v0",
                  "AntWallTest-v0",
