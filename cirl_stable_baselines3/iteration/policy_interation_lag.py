...
class PolicyIterationLagrange(ABC):
    ...
    def learn(self,
        ...
        for iter in tqdm(range(total_timesteps)):
            ...
            self.policy_evaluation(cost_info_str,density_loss,latent_info_str)
            # Run the policy improvement algorithm
            policy_stable = self.policy_improvement(cost_info_str,density_loss,latent_info_str)
    ...
    def policy_evaluation(self, cost_function,density_loss,latent_info_str):
        iter = 0
        ...
        while delta >= self.stopping_threshold:
            ...
            for x in range(self.height):
                for y in range(self.height):
                    ...
                    self.bellman_update(old_v, x, y, cost_function,density_loss,latent_info_str)
                    # Compute difference
