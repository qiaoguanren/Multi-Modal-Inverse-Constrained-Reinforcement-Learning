...
import cirl_stable_baselines3
from cirl_stable_baselines3.common.type_aliases import TensorDict
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("_stable_baselines3_version", cirl_stable_baselines3.__version__)
